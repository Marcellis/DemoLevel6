...
*/
        sURIMatcher.addURI(RemindersContract.AUTHORITY, RemindersContract.ReminderEntry.TABLE_NAME, REMINDERS);
        sURIMatcher.addURI(RemindersContract.AUTHORITY, RemindersContract.ReminderEntry.TABLE_NAME + "/#", REMINDERS_ID);
        return sURIMatcher;
    }
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        ...
        switch (match) {
            case REMINDERS:
                ...
                if ( id > 0 ) {
                    returnUri = ContentUris.withAppendedId(RemindersContract.CONTENT_URI, id);
                } else {
